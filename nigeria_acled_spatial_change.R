### Preamble ###############################################################
# Islamist insurgency in Nigeria - ACLED: Spatial change analysis
...
data <- readRDS("data/nigeria-acled.rds")
...
write_csv(nodes.2011, "out/nigeria-acled-2011-centrality-measures.csv")
...
st_write(buffer.2011, "out/nigeria-acled-2011-conflict-shape.shp")
...
ggsave("figs/nigeria-acled-2011-conflict-shape-hotspot.png", width = 8, height = 4)
...
st_write(hotspot.2011, "out/nigeria-acled-2011-hotspot.shp")
...
ggplot() +
  ...
  geom_text(data= world_points,aes(x=X, y=Y, label=name),
            color = "gray20", fontface = "italic", check_overlap = T, size = 3)
ggsave("figs/nigeria-acled-2011-events.png", width = 8, height = 4)
...
write_csv(nodes.2016, "out/nigeria-acled-2016-centrality-measures.csv")
...
st_write(buffer.2016, "out/nigeria-acled-2016-conflict-shape.shp")
...
ggplot() +
  ...
  geom_text(data= world_points,aes(x=X, y=Y, label=name),
            color = "gray20", fontface = "italic", check_overlap = T, size = 3)
ggsave("figs/nigeria-acled-2016-conflict-shape-hotspot.png", width = 8, height = 4)
...
st_write(hotspot.2016, "out/nigeria-acled-2016-hotspot.shp")
...
ggplot() +
  ...
  geom_text(data= world_points,aes(x=X, y=Y, label=name),
            color = "gray20", fontface = "italic", check_overlap = T, size = 3)
ggsave("figs/nigeria-acled-2016-events.png", width = 8, height = 4)
...
ggplot() +
  ...
  ggtitle("Islamist insurgency - ACLED, 2011-2016: Spatial change") +
  theme_bw() +
  labs( x = "Longitude", y = "Latitude") +
  ...
  geom_label(data = label.2016, 
             aes(x = x, y = y, label = text), 
             color = "red")
ggsave("figs/nigeria-acled-2011-2016-spatial-change.png", width = 8, height = 4)
