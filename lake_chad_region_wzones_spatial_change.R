### Preamble ###############################################################
# Armed conflict in the Lake Chad region - Wzones: Spatial change analysis
...
ggsave("figs/lake-chad-region-wzones-2011-conflict-shape-hotspot.png", width = 8, height = 4)
...
st_write(hotspot.2011, "out/lake-chad-region-wzones-2011-hotspot.shp")
...
ggplot() +
  ...
  geom_text(data= world_points,aes(x=X, y=Y, label=name),
            color = "gray20", fontface = "italic", check_overlap = T, size = 3)
ggsave("figs/lake-chad-region-wzones-2016-conflict-shape-hotspot.png", width = 8, height = 4)
...
st_write(hotspot.2016, "out/lake-chad-region-wzones-2016-hotspot.shp")
...
ggplot() +
  ...
  geom_label(data = label.2016, 
             aes(x = x, y = y, label = text), 
             color = "red")
ggsave("figs/lake-chad-region-wzones-2011-2016-spatial-change.png", width = 8, height = 4)
...
overl_hotspot.2011.2016 # 35.81444
...
spatial_ch.2011.2016 # 50.55523 (no shift)
