### Preamble ###############################################################
# Armed conflict in the Lake Chad region: Spatial change analysis
...
write_csv(nodes.2011, "out/lake-chad-region-2011-centrality-measures.csv")
...
ggnet2(net.2011,
  ...
  ggtitle("Armed conflict in the Lake Chad region in Nigeria, 2011")
ggsave("figs/lake-chad-region-2011-network.png", width = 10, height = 2.5)
...
st_write(buffer.2011, "out/lake-chad-region-2011-conflict-shape.shp")
...
ggsave("figs/lake-chad-region-2011-conflict-shape-hotspot.png", width = 8, height = 4)
...
st_write(hotspot.2011, "out/lake-chad-region-2011-hotspot.shp")
...
ggplot() +
  ...
  geom_text(data= world_points,aes(x=X, y=Y, label=name),
            color = "gray20", fontface = "italic", check_overlap = T, size = 3)
ggsave("figs/lake-chad-region-2011-events.png", width = 8, height = 4)
...
write_csv(nodes.2016, "out/lake-chad-region-2016-centrality-measures.csv")
...
ggnet2(net.2016,
       ...
       edge.label.alpha = 0.6) +
  ggtitle("Armed conflict in the Lake Chad region in Nigeria, 2016")
ggsave("figs/lake-chad-region-2016-network.png", width = 10, height = 4)
...
st_write(buffer.2016, "out/lake-chad-region-2016-conflict-shape.shp")
...
ggplot() +
  ...
  geom_text(data= world_points,aes(x=X, y=Y, label=name),
            color = "gray20", fontface = "italic", check_overlap = T, size = 3)
ggsave("figs/lake-chad-region-2016-conflict-shape-hotspot.png", width = 8, height = 4)
...
st_write(hotspot.2016, "out/lake-chad-region-2016-hotspot.shp")
...
ggplot() +
  ...
  geom_text(data= world_points,aes(x=X, y=Y, label=name),
            color = "gray20", fontface = "italic", check_overlap = T, size = 3)
ggsave("figs/lake-chad-region-2016-events.png", width = 8, height = 4)
...
ggplot() +
  ...
  ggtitle("Armed conflict in the Lake Chad region, 2011-2016: Spatial change") +
  theme_bw() +
  labs( x = "Longitude", y = "Latitude") +
  ...
  geom_label(data = label.2016, 
             aes(x = x, y = y, label = text), 
             color = "red")
ggsave("figs/lake-chad-region-2011-2016-spatial-change.png", width = 8, height = 4)
...
st_write(buffer.2011.GRID75, "out/lake-chad-region-conflict-2011_GRID75-shape.shp")
...
st_write(hotspot.2011.GRID75, "out/lake-chad-region-2011_GRID75-hotspot.shp")
...
st_write(buffer.2016.GRID75, "out/lake-chad-region-conflict-2016_GRID75-shape.shp")
...
st_write(hotspot.2016.GRID75, "out/lake-chad-region-2016_GRID75-hotspot.shp")
...
st_write(buffer.2011.GRID100, "out/lake-chad-region-conflict-2011_GRID100-shape.shp")
...
st_write(hotspot.2011.GRID100, "out/lake-chad-region-2011_GRID100-hotspot.shp")
...
st_write(buffer.2016.GRID100, "out/lake-chad-region-conflict-2016_GRID100-shape.shp")
...
st_write(hotspot.2016.GRID100, "out/lake-chad-region-2016_GRID100-hotspot.shp")
...
st_write(buffer.2011.BUFF75, "out/lake-chad-region-conflict-2011_BUFF75-shape.shp")
...
st_write(hotspot.2011.BUFF75, "out/lake-chad-region-2011_BUFF75-hotspot.shp")
...
st_write(buffer.2016.BUFF75, "out/lake-chad-region-conflict-2016_BUFF75-shape.shp")
...
st_write(hotspot.2016.BUFF75, "out/lake-chad-region-2016_BUFF75-hotspot.shp")
...
st_write(buffer.2011.BUFF100, "out/lake-chad-region-conflict-2011_BUFF100-shape.shp")
...
st_write(hotspot.2011.BUFF100, "out/lake-chad-region-2011_BUFF100-hotspot.shp")
...
st_write(buffer.2016.BUFF100, "out/lake-chad-region-conflict-2016_BUFF100-shape.shp")
...
st_write(hotspot.2016.BUFF100, "out/lake-chad-region-2016_BUFF100-hotspot.shp")
